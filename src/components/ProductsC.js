    ...
    return (
        ...
        <div className = 'Cgfilter'>
            ...
            <ul>
                    ...
                    <Link className = 'lined'  to = '?cg=Clothes'>Clothes</Link>
                    <Link className = 'lined'  to = '?cg=Accessories'>Accessories</Link>
                    <Link className = 'lined'  to = '?cg=Stationery'>Stationery</Link>
                    <Link to = '?cg=Bag' className = 'lined'>Bags</Link>
                    <Link to = '?cg=Badges' className = 'lined'>Badges</Link>
                    <Link to = '?cg=Electronics' className = 'lined'>Electronics</Link>
