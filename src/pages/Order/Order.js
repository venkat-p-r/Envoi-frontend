            ...
            <div className="informations-placeorder">
                <div className="shipping-placeorder">
                    ...
                    <p>
                        ...
                        {order.shippingAddress.phnumber}
                    </p>
                        {order.isDelivered ? <div className = 'paid'>Delivered at {order.deliveredAt}</div> : <div className = 'notpaid'>Your Order Will Deliver Soon</div>}
